                ...
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Jabatan</label>
                        <select name="jabatan" id="" class="form-control">
                            ...
                            <option <?php echo ($data['jabatan'] == "Fuul Time") ? 'selected' : '' ?> value="Fuul Time">Fuul Time</option>
                            <option <?php echo ($data['jabatan'] == "Part Time") ? 'selected' : '' ?> value="Part Time">Part Time</option>
                            </select>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Email</label>
                    <input type="email" value="<?=$data['email']?>" name="email" class="form-control" id="exampleInputPassword1">
                </div>
                <div class="mb-3">
